...
class ActivityEdit extends Component {
    ...
    constructor(props) {
      ...
      fetchAcitivyById() {
        ...
        axiosConfig
        .get(`/api/v1/activity/${idUrl}`)
        .then((res) => {
            console.log(res.data.data);
            let resp = res.data.data;
            this.setState({title : resp.title,
                description: resp.description,
                imageUrls: resp.imageUrls[0],
                price: resp.price,
                price_discount: resp.price_discount,
                rating: resp.rating,
                ...
                city:resp.city,
                location_maps:resp.location_maps,
                categorySelected: res.data.data.categoryId,
                idUrl : idUrl
            });
        })
        .catch(err => {
      ...
      handleSaveClick = () => {
        ...
        axiosConfig
        .post(`/api/v1/update-activity/${this.state.idUrl}`, payload)
        .then((res) => {
            console.log(res.data)
            Swal.fire({
                position: 'center',
                icon: 'success',
                title: 'Activity was successfully created!',
    ...
    render(){
        ...
        return (
            ...
            <Container>
                <Center><Title size="h1" >Update Activity</Title></Center>
                ...
                />
                 ...
                 <NumberInput
                    ...
                    onChange={(value) => {
                        this.setState({ price_discount: value })
                    }}
